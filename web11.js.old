...
// Telegram notifications only for the active (newest-ending) streak: x5 start, x6+ extensions
// Features: save-on-break only, persistent history file, clear history button, animated glow, FILTER = exact length
...
// Telegram bot config (from your original)
...
// Fetch polyfill if needed (so sendTelegramMessage works)
